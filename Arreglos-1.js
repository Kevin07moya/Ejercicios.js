...
const pelicula = ["La milla verde", "Parásitos", "El viaje de Chihiro", "Coco", "Interstellar"];

for (let i = 0; i < pelicula.length; i++) {
  console.log(`Película ${pelicula[i]}`);
}

for (const item of pelicula) {
   console.log(`peli ${pelicula}`)
}

const peliculas1=['la milla verde','parásitos','el viaje de chihiro','coco','interstellar'];

for (let i = 0; i < peliculas1.length; i++) {
    console.log(`Pelicula(${i}):${peliculas1[i]}`)    
    }0