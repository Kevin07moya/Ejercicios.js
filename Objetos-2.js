...
class Figura { //La clase perro extiende de la clase animal-
    constructor(color){
        //Propiedad de la clase perro.
        this.color=color;
    }
...
class cuadrado extends Figura { 
    ...
    saludar(){ //sobreescritura del metodo saludar
        console.log(`Hola! Soy un cuadrado. Mi color es ${this.color} y mis medidas son ${this.alto*this.ancho}`)
    }
